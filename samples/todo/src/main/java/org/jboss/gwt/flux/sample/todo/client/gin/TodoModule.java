 ...
 * @author Harald Pehl
 */
public class TodoModule extends AbstractGinModule {

    @Override
    protected void configure() {
        bind(Dispatcher.class).to(TodoDispatcher.class).in(Singleton.class);
        bind(TodoStore.class).in(Singleton.class);
    }
}
