...
public class TrousersStore {

    @Process(actionType = Dress.class, dependencies = UnderwearStore.class)
    public void dress(Dispatcher.Channel channel) {
        channel.ack();
    }

    @org.jboss.gwt.circuit.meta.Process(actionType = Undress.class, dependencies = {CoatStore.class, ShoesStore.class})
